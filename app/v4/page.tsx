...
function MissionLabel({ code, title }: { code: string; title: string }) {
  return (
    <p className="font-mono text-xs tracking-[0.35em] text-red-500 mb-3">
      [{code}] <span className="text-white/40">{title}</span>
    </p>
  );
}
      ...
      <main className="relative z-10">
        ...
        >
          <div className="container mx-auto px-6 pb-28">
            <MissionLabel code="TRANSMISSION" title="INCOMING" />
            <h1 className="text-6xl md:text-8xl font-extrabold tracking-tight">
              SABBZ<span className="text-red-500">.</span>
            </h1>
            <p className="mt-4 max-w-md text-white/60 leading-relaxed">
              Roblox scripter & frontend developer. Follow me — I&apos;ll show
              you around.
            </p>
            ...
            <p className="mt-10 font-mono text-xs tracking-[0.3em] text-red-500 animate-pulse">
              ▼ SCROLL TO FOLLOW
            </p>
          </div>
        </section>
        ...
        >
          <div className="container mx-auto px-6 pb-32">
            ...
            <h2 className="text-4xl md:text-6xl font-extrabold leading-tight max-w-2xl">
