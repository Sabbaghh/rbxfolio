  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="relative">
        ...
        <ParallaxBackground className="border-b border-border">
            ...
            <div className="max-w-3xl">
              ...
              <ParallaxSection speed={0.15}>
                <p className="mt-6 text-lg md:text-xl text-muted-foreground leading-relaxed max-w-2xl">
                  Professional scripter specializing in game systems, performance optimization, 
                  and multiplayer architecture. I turn game concepts into polished, production-ready experiences.
                </p>
              ...
              <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-6">
                {[
                  ...
                  <ParallaxSection key={stat.label} speed={0.05 + index * 0.02}>
                    <div className="text-center md:text-left group">
                      <div className="flex items-center justify-center md:justify-start gap-2 text-muted-foreground mb-1 group-hover:text-primary transition-colors">
          ...
          <div className="container mx-auto px-4 relative">
            <ParallaxSection speed={0.1}>
              <div className="flex items-center justify-between mb-8">
                <div>
                  ...
                  <p className="text-muted-foreground mt-1">Games I&apos;ve contributed to as a scripter</p>
                </div>
              </div>
            </ParallaxSection>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {(gamesData as Game[]).map((game, index) => (
                <ParallaxSection key={game.id} speed={0.03 + (index % 3) * 0.02}>
                  <GameCard
                    {...game}
        ...
        <section className="py-16 md:py-24 bg-secondary/30 border-y border-border">
          <div className="container mx-auto px-4">
            <div className="mb-8">
              <h2 className="text-2xl md:text-3xl font-bold text-foreground">Try My Skills</h2>
              <p className="text-muted-foreground mt-1">A mini-game showcasing game logic, physics, and input handling</p>
            </div>
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4">
            <div className="mb-8">
              ...
              <p className="text-muted-foreground mt-1">Clips and demos from my X feed</p>
            </div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <ParallaxSection speed={0.15}>
              <p className="mt-4 text-lg text-muted-foreground max-w-xl mx-auto">
                Whether you need a complete game system, performance optimization, or just a second opinion on architecture.
              </p>
              <div className="mt-8">
                <ContactButton />
              </div>
